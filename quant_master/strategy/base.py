    ...
    def __init__(
        ...
        **kwargs,
        ...
        state_interpreter : Union[dict, StateInterpreter]
            interpreter that interprets the quant_master execute result into rl env state
        action_interpreter : Union[dict, ActionInterpreter]
            interpreter that interprets the rl agent action into quant_master order list
