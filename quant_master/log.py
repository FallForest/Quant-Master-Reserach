...
class _QLibLoggerManager:
    ...
    def __call__(self, module_name, level: Optional[int] = None) -> QuantMasterLogger:
        """
        ...
        # Get logger.
        module_logger = self._loggers.setdefault(module_name, QuantMasterLogger(module_name))
...
def set_global_logger_level(level: int, return_orig_handler_level: bool = False):
    """set quant_master.xxx logger handlers level
    ...
    ---------
        ...
        .. code-block:: python
            ...
            import quant_master
            import logging
            from quant_master.log import get_module_logger, set_global_logger_level
            quant_master.init()
    ...
    """
    _handler_level_map = {}
    quant_master_logger = logging.root.manager.loggerDict.get("quant_master", None)  # pylint: disable=E1101
    if quant_master_logger is not None:
        for _handler in quant_master_logger.handlers:
...
def set_global_logger_level_cm(level: int):
    """set quant_master.xxx logger handlers level to use contextmanager
    ...
    ---------
        ...
        .. code-block:: python
            ...
            import quant_master
            import logging
            from quant_master.log import get_module_logger, set_global_logger_level_cm
            quant_master.init()
