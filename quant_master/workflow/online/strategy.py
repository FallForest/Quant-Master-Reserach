...
from quant_master.utils import transform_end_date
from quant_master.workflow.online.utils import OnlineTool, OnlineToolR
from quant_master.workflow.recorder import Recorder
from quant_master.workflow.task.collect import Collector, RecorderCollector
...
class OnlineStrategy:
    ...
    def __init__(self, name_id: str):
        """
        Init OnlineStrategy.
        This module **MUST** use `Trainer <../reference/api.html#quant_master.model.trainer.Trainer>`_ to finishing model training.

        Args:
            name_id (str): a unique name or id.
            trainer (quant_master.model.trainer.Trainer, optional): a instance of Trainer. Defaults to None.
        """
