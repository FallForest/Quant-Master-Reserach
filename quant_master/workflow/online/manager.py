...
import pandas as pd
from quant_master import get_module_logger
from quant_master.data.data import D
from quant_master.log import set_global_logger_level
from quant_master.model.ens.ensemble import AverageEnsemble
from quant_master.model.trainer import Trainer, TrainerR
from quant_master.utils.serial import Serializable
from quant_master.workflow.online.strategy import OnlineStrategy
from quant_master.workflow.task.collect import MergeCollector
...
class OnlineManager(Serializable):
    ...
    def __init__(
        ...
        Args:
            ...
            trainer (quant_master.model.trainer.Trainer): the trainer to train task. None for using TrainerR.
