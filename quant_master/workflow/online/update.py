...
from quant_master.data.dataset import Dataset, DatasetH, TSDatasetH
from quant_master.data.dataset.handler import DataHandlerLP
from quant_master.model import Model
from quant_master.utils import get_date_by_shift
...
class DSBasedUpdater(RecordUpdater, metaclass=ABCMeta):
    ...
    - Providing updating feature for Updating data based on QuantMaster Dataset

    Assumption

    - Based on QuantMaster dataset
