...
from quant_master import auto_init, get_module_logger
...
class TaskManager:
    ...
    python -m quant_master.workflow.task.manage -h # show manual of manage module CLI
    python -m quant_master.workflow.task.manage wait -h # show manual of the wait command of manage

    .. code-block:: shell

        python -m quant_master.workflow.task.manage -t <pool_name> wait
        python -m quant_master.workflow.task.manage -t <pool_name> task_stat
    ...
    def query(self, query=None, decode=True):
        ...
        python -m quant_master.workflow.task.manage -t <your task pool> query '{"_id": "615498be837d0053acbc5d58"}'
...
if __name__ == "__main__":
    ...
    # E.g. : `python -m quant_master.workflow.task.manage list`
    auto_init()
