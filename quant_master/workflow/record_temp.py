...
from ..utils.exceptions import QuantMasterException
...
class PortAnaRecord(ACRecordTemp):
    ...
    - report_normal.pkl & positions_normal.pkl:
        ...
        - The return report and detailed positions of the backtest, returned by `quant_master/contrib/evaluate.py:backtest`
    - port_analysis.pkl : The risk analysis of your portfolio, returned by `quant_master/contrib/evaluate.py:risk_analysis`
    """
...
class MultiPassPortAnaRecord(PortAnaRecord):
    ...
    def __init__(self, recorder, pass_num=10, shuffle_init_score=True, **kwargs):
        ...
        if not isinstance(self.original_strategy, dict):
            raise QuantMasterException("MultiPassPortAnaRecord require the passed in strategy to be a dict")
        if "signal" not in self.original_strategy.get("kwargs", {}):
            raise QuantMasterException("MultiPassPortAnaRecord require the passed in strategy to have signal as a parameter")
