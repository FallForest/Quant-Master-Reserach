...
class QuantMasterRecorder:
    ...
    def start(
        ...
        *,
        ...
        uri : str
            ...
            The default uri is set in the quant_master.config. Note that this uri argument will not change the one defined in the config file.
    ...
    def start_exp(
        ...
        *,
        ...
        uri : str
            the tracking uri of the experiment, where all the artifacts/metrics etc. will be stored.
            The default uri are set in the quant_master.config.
        resume : bool
            whether to resume the specific recorder with given name under the given experiment.
    ...
    def search_records(self, experiment_ids, **kwargs):
        ...
        ``ExpManager`` in ``QuantMaster``. ``QuantMaster`` now provides an implementation of ``ExpManager`` with mlflow, and here is the
    ...
    def list_recorders(self, experiment_id=None, experiment_name=None):
        ...
        can be found `here <../component/recorder.html#quant_master.workflow.exp.Experiment>`__).
    ...
    def save_objects(self, local_path=None, artifact_path=None, **kwargs: Dict[Text, Any]):
        ...
        1. QuantMaster provide two methods to specify **objects**
...
class RecorderWrapper(Wrapper):
    """
    Wrapper class for QuantMasterRecorder, which detects whether users reinitialize quant_master when already starting an experiment.
    """
        ...
        if self._provider is not None:
            ...
            if expm.active_experiment is not None:
                raise RecorderInitializationError(
                    "Please don't reinitialize QuantMaster if QuantMasterRecorder is already activated. Otherwise, the experiment stored location will be modified."
                )
...
if sys.version_info >= (3, 9):
    ...
    QuantMasterRecorderWrapper = Annotated[QuantMasterRecorder, RecorderWrapper]
else:
    QuantMasterRecorderWrapper = QuantMasterRecorder

# global record
R: QuantMasterRecorderWrapper = RecorderWrapper()
