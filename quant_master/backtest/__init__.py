...
# make import more user-friendly by adding `from quant_master.backtest import STH`
...
def format_decisions(
    ...
    """
    format the decisions collected by `quant_master.backtest.collect_data`
    The decisions will be organized into a tree-like structure.

    Parameters
    ----------
    decisions : List[BaseTradeDecision]
        decisions collected by `quant_master.backtest.collect_data`
