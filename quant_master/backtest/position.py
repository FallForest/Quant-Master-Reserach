...
class Position(BasePosition):
    ...
    def fill_stock_value(self, start_time: Union[str, pd.Timestamp], freq: str, last_days: int = 30) -> None:
        """fill the stock value by the close price of latest last_days from quant_master.
        ...
        if len(price_dict) < len(stock_list):
            ...
            raise ValueError(f"{lack_stock} doesn't have close price in quant_master in the latest {last_days} days")
