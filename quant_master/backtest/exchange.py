...
from quant_master.backtest.position import BasePosition
...
class Exchange:
        ...
        **kwargs: Any,
        ...
        :param volume_threshold: Union[
                                ...
                                1) ("cum" or "current", limit_str) denotes a single volume limit.
                                    - limit_str is quant_master data expression which is allowed to define your own Operator.
                                    Please refer to quant_master/contrib/ops/high_freq.py, here are any custom operator for
                                    high frequency, such as DayCumsum. !!!NOTE: if you want you use the custom
                                    operator, you need to register it in quant_master_init.
        ...
        self.get_quote_from_quant_master()

        # init quote by quote_df
        self.quote_cls = quote_cls
        self.quote: BaseQuote = self.quote_cls(self.quote_df, freq)

    def get_quote_from_quant_master(self) -> None:
        # get stock data from quant_master
        if len(self.codes) == 0:
    ...
    LT_TP_EXP = "(exp)"  # Tuple[str, str]:  the limitation is calculated by a QuantMaster expression.
    ...
    def _get_vol_limit(volume_threshold: Union[tuple, dict, None]) -> Tuple[Optional[list], Optional[list], set]:
        ...
        get the fields need to get from quant_master.
        ...
        -------
        fields: set
            the fields need to get from quant_master.
