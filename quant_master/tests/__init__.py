...
from quant_master.data.data import Cal, DatasetD
from quant_master.data.storage import CalendarStorage, InstrumentStorage, FeatureStorage, CalVT, InstKT, InstVT
...
class TestMockData(unittest.TestCase):
    _setup_kwargs = {
        "calendar_provider": {
            ...
            "kwargs": {"backend": {"class": "MockCalendarStorage", "module_path": "quant_master.tests"}},
        },
        "instrument_provider": {
            "class": "LocalInstrumentProvider",
            "module_path": "quant_master.data.data",
            "kwargs": {"backend": {"class": "MockInstrumentStorage", "module_path": "quant_master.tests"}},
        },
        "feature_provider": {
            "class": "LocalFeatureProvider",
            "module_path": "quant_master.data.data",
            "kwargs": {"backend": {"class": "MockFeatureStorage", "module_path": "quant_master.tests"}},
        },
    }
