...
"""
QuantMaster follow the logic below to supporting point-in-time database
...
QuantMaster will use the operator `P` to perform the collapse.
"""

import numpy as np
import pandas as pd
from quant_master.data.ops import ElemOperator
