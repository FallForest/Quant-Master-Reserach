...
from quant_master.utils import load_dataset, init_instance_by_config, time_to_slc_point
...
class DLWParser(DataLoader):
    ...
    Extracting this class so that QuantMasterDataLoader and other dataloaders(such as QdbDataLoader) can share the fields.
    """
...
class QuantMasterDataLoader(DLWParser):
    """Same as QuantMasterDataLoader. The fields can be define by config"""
...
class DataLoaderDH(DataLoader):
    ...
    def __init__(self, handler_config: dict, fetch_kwargs: dict = {}, is_group=False):
        ...
        """
        from quant_master.data.dataset.handler import DataHandler  # pylint: disable=C0415
