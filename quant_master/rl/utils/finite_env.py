...
class FiniteVectorEnv(BaseVectorEnv):
    ...
    The requirement is to make every possible seed (stored in :class:`quant_master.rl.utils.DataQueue` in our case)
    ...
    The single environment (should be :class:`quant_master.rl.utils.EnvWrapper` in our case) is responsible for
    ...
    from child workers. See :class:`quant_master.rl.utils.LogWriter`.
    """
