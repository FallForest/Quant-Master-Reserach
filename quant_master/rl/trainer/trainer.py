...
from quant_master.rl.simulator import InitialStateType
from quant_master.rl.utils import EnvWrapper, FiniteEnvType, LogBuffer, LogCollector, LogLevel, LogWriter, vectorize_env
from quant_master.rl.utils.finite_env import FiniteVectorEnv
...
class Trainer:
    ...
    fast_dev_run
        ...
        For :class:`~quant_master.rl.vessel.TrainingVessel`, if greater than zero,
