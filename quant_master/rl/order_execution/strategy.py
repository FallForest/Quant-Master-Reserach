...
from quant_master.backtest import CommonInfrastructure, Order
from quant_master.backtest.decision import BaseTradeDecision, TradeDecisionWithDetails, TradeDecisionWO, TradeRange
from quant_master.backtest.exchange import Exchange
from quant_master.backtest.executor import BaseExecutor
from quant_master.backtest.utils import LevelInfrastructure, get_start_end_idx
from quant_master.constant import EPS, ONE_MIN, REG_CN
from quant_master.rl.data.native import IntradayBacktestData, load_backtest_data
from quant_master.rl.interpreter import ActionInterpreter, StateInterpreter
from quant_master.rl.order_execution.state import SAOEMetrics, SAOEState
from quant_master.rl.order_execution.utils import dataframe_append, price_advantage
from quant_master.strategy.base import RLStrategy
from quant_master.utils import init_instance_by_config
from quant_master.utils.index_data import IndexData
from quant_master.utils.time import get_day_min_idx_range
...
class SAOEStrategy(RLStrategy):
    ...
    def _create_quant_master_backtest_adapter(
        self,
        order: Order,
        trade_decision: BaseTradeDecision,
    ...
    def reset(self, outer_trade_decision: BaseTradeDecision | None = None, **kwargs: Any) -> None:
        ...
        if outer_trade_decision is not None and not outer_trade_decision.empty():
            ...
            for decision in outer_trade_decision.get_decision():
                ...
                self.adapter_dict[order.key_by_day] = self._create_quant_master_backtest_adapter(
