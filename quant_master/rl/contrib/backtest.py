...
from quant_master.backtest import INDICATOR_METRIC, collect_data_loop, get_strategy_executor
from quant_master.backtest.decision import BaseTradeDecision, Order, OrderDir, TradeRangeByTime
from quant_master.backtest.executor import SimulatorExecutor
from quant_master.backtest.high_performance_ds import BaseOrderIndicator
from quant_master.rl.contrib.naive_config_parser import get_backtest_config_fromfile
from quant_master.rl.contrib.utils import read_order_file
from quant_master.rl.data.integration import init_quant_master
from quant_master.rl.order_execution.simulator_quant_master import SingleAssetOrderExecution
from quant_master.typehint import Literal
...
def single_with_simulator(
    ...
    """
    init_quant_master(backtest_config["quant_master"])
