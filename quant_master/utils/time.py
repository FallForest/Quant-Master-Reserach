...
from quant_master.constant import REG_CN, REG_TW, REG_US
...
class Freq:
    ...
    NORM_FREQ_WEEK = "week"
    NORM_FREQ_DAY = "day"
    NORM_FREQ_MINUTE = "min"  # using min instead of minute for align with QuantMaster's data filename
    ...
    def __str__(self):
        # trying to align to the filename of QuantMaster: day, 30min, 5min, 1min...
