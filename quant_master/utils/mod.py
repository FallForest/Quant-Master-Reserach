...
from quant_master.typehint import InstConf
...
def find_all_classes(module_path: Union[str, ModuleType], cls: type) -> List[type]:
    ...
    - `cls` itself is also included
        ...
        >>> from quant_master.data.dataset.handler import DataHandler
        >>> find_all_classes("quant_master.contrib.data.handler", DataHandler)
        [<class 'quant_master.contrib.data.handler.Alpha158'>, <class 'quant_master.contrib.data.handler.Alpha158vwap'>, <class 'quant_master.contrib.data.handler.Alpha360'>, <class 'quant_master.contrib.data.handler.Alpha360vwap'>, <class 'quant_master.data.dataset.handler.DataHandlerLP'>]
