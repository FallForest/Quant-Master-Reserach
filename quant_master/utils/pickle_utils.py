...
# These are common data types used in quant_master that should be safe to deserialize
SAFE_PICKLE_CLASSES: Set[Tuple[str, str]] = {
    ...
    ("pathlib", "PosixPath"),
    ("pathlib", "WindowsPath"),
    ("quant_master.data.dataset.handler", "DataHandler"),
    ("quant_master.data.dataset.handler", "DataHandlerLP"),
    ("quant_master.data.dataset.loader", "StaticDataLoader"),
}
...
class RestrictedUnpickler(pickle.Unpickler):
    ...
    def find_class(self, module: str, name: str):
        ...
        # 2. explicit whitelist (quant_master internal)
