...
.. code-block:: python
    ...
    from quant_master.contrib.report.data.ana import FeaMeanStd
...
import pandas as pd
import numpy as np
from quant_master.contrib.report.data.base import FeaAnalyser
from quant_master.contrib.report.utils import sub_fig_generator
from quant_master.utils.paral import datetime_groupby_apply
from quant_master.contrib.eva.alpha import pred_autocorr_all
