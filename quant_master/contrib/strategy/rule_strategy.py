...
from quant_master.data.dataset.utils import convert_index_format
...
from quant_master.utils.file import get_io_object
from quant_master.backtest.utils import get_start_end_idx
    ...
    def __init__(
        ...
        **kwargs,
        ...
        trade_range : Tuple[int, int]
            ...
            - `quant_master/utils/time.py:def get_day_min_idx_range` can help you create the index range easier
