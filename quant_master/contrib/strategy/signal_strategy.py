...
from quant_master.model.base import BaseModel
from quant_master.strategy.base import BaseStrategy
from quant_master.backtest.position import Position
from quant_master.backtest.signal import Signal, create_signal_from
from quant_master.backtest.decision import Order, OrderDir, TradeDecisionWO
from quant_master.log import get_module_logger
from quant_master.utils import get_pre_trading_date, load_dataset
from quant_master.contrib.strategy.order_generator import OrderGenerator, OrderGenWOInteract
from quant_master.contrib.strategy.optimizer import EnhancedIndexingOptimizer
...
class BaseSignalStrategy(BaseStrategy, ABC):
    def __init__(
        ...
        **kwargs,
        ...
        -----------
        signal :
            the information to describe a signal. Please refer to the docs of `quant_master.backtest.signal.create_signal_from`
        ...
        # This is trying to be compatible with previous version of quant_master task config
...
class EnhancedIndexingStrategy(WeightStrategyBase):
    ...
    `quant_master.model.riskmodel.structured.StructuredCovEstimator` to prepare these data.
