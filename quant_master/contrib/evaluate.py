...
def risk_analysis(r, N: int = None, freq: str = "day", mode: Literal["sum", "product"] = "sum"):
    ...
    QuantMaster tries to cumulate returns by summation instead of production to avoid the cumulated curve being skewed exponentially.
    All the calculation of annualized returns follows this principle in QuantMaster.
...
def long_short_backtest(
    ...
    :param extract_codes:  bool.
                       ...
                       NOTE: This will be faster with offline quant_master.
