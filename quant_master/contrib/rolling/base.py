...
from quant_master.model.ens.ensemble import RollingEnsemble
from quant_master.model.trainer import TrainerR
from quant_master.utils import get_cls_kwargs, init_instance_by_config
...
class Rolling:
    ...
    **NOTE**
    ...
    def __init__(
        ...
        # FIXME:
        # - the quant_master_init section will be ignored by me.
    ...
    def get_task_list(self) -> List[dict]:
        ...
        for t in task_l:
            ...
            t["record"] = ["quant_master.workflow.record_temp.SignalRecord"]
        return task_l
