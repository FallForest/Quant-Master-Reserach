...
from quant_master.contrib.meta.data_selection.dataset import InternalData, MetaDatasetDS
from quant_master.contrib.meta.data_selection.model import MetaModelDS
from quant_master.data.dataset.handler import DataHandlerLP
from quant_master.model.meta.task import MetaTask
from quant_master.model.trainer import TrainerR
...
from quant_master.workflow.task.utils import replace_task_handler_with_cache
...
LINEAR_MODEL = """
class: LinearModel
module_path: quant_master.contrib.model.linear
kwargs:
    estimator: ridge
    alpha: 0.05
"""
    ...
    **NOTE**
    ...
    def _train_meta_model(self, fill_method="max"):
        ...
        proxy_forecast_model_task = {
            # "model": "quant_master.contrib.model.linear.LinearModel",
            "dataset": {
                "class": "quant_master.data.dataset.DatasetH",
                "kwargs": {
            ...
            # "record": ["quant_master.workflow.record_temp.SignalRecord"]
        }
    ...
    def get_task_list(self):
        ...
        # 3) meta model make inference and get new quant_master task
