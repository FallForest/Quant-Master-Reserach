...
.. autoclass:: quant_master.model.meta.task.MetaTask
    :members:
...
.. autoclass:: quant_master.model.meta.dataset.MetaTaskDataset
    :members:
...
.. autoclass:: quant_master.model.meta.model.MetaModel
    :members:
...
.. autoclass:: quant_master.model.meta.model.MetaTaskModel
    :members:
...
.. autoclass:: quant_master.model.meta.model.MetaGuideModel
    :members:


Example
=======
``QuantMaster`` provides an implementation of ``Meta Model`` module, ``DDG-DA``,
...
The `above example <https://github.com/microsoft/quant_master/tree/main/examples/benchmarks_dynamic/DDG-DA>`_ can be found in ``examples/benchmarks_dynamic/DDG-DA/workflow.py``.
