# GPU Deep Stack Summary (full, 20260522T110051Z)

- command: `examples/benchmarks/Transcendence/gpu_deep_stack_model.py --mode full --tracking-uri file:./mlruns --base-run-id 7406e47063e9479cb34d300b9ed03bad --start-date 2024-01-01 --end-date 2026-04-30 --open-cost 0.0005 --close-cost 0.0015 --topk 45 --n-drop 4 --output-prefix gpu_deep_stack_workerA`
...
- name: `blend_base85_deep15`
- full IR: `2.158556`
- full AnnRet: `0.182896`
- full MDD: `-0.059171`
- turnover: `0.174715`
- 2026YTD IR: `2.267992`
- 2026YTD AnnRet: `0.218905`
