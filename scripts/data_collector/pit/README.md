...
```bash
cd quant_master/scripts/data_collector/pit/
# download from baostock.com
python collector.py download_data --source_dir ~/.quant_master/stock_data/source/pit --start 2000-01-01 --end 2020-01-01 --interval quarterly
```
...
```bash
python collector.py download_data --source_dir ~/.quant_master/stock_data/source/pit --start 2000-01-01 --end 2020-01-01 --interval quarterly --symbol_regex "^(600519|000725).*"
```


### Normalize Data
```bash
python collector.py normalize_data --interval quarterly --source_dir ~/.quant_master/stock_data/source/pit --normalize_dir ~/.quant_master/stock_data/source/pit_normalized
```
