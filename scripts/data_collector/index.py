...
class IndexBase:
    ...
    def save_new_companies(self):
        ...
        Examples
        -------
            $ python collector.py save_new_companies --index_name CSI300 --quant_master_dir ~/.quant_master/quant_master_data/tdx_cn_data
        """
    ...
    def parse_instruments(self):
        ...
        Examples
        -------
            $ python collector.py parse_instruments --index_name CSI300 --quant_master_dir ~/.quant_master/quant_master_data/tdx_cn_data
        """
